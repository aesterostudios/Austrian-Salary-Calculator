...
export const translations: Record<Language, Dictionary> = {
  en: {
    common: {
      ...
      familyBonusOptions: [
        { id: "none", label: "no Family Bonus Plus" },
        { id: "shared", label: "shared Family Bonus Plus" },
        { id: "full", label: "full Family Bonus Plus" },
      ],
    },
    home: {
      badge: "Gross-to-net calculator",
      headline: "Estimate your Austrian net salary.",
      ...
      family: {
        ...
        childrenOver18:
          "Children from 18 years for whom you receive Austrian family allowance (Familienbeihilfe)",
        childrenOver18Note:
          "For whom the Austrian family allowance (Familienbeihilfe) is paid",
    ...
    result: {
      ...
      summaryMetrics: {
        ...
        footnote: "including 13th and 14th salary payments (Urlaubsgeld & Weihnachtsgeld)",
      },
      ...
      labels: {
        ...
        childrenOver18Note: "For whom the Familienbeihilfe (family allowance) is paid",
        singleEarner: "Single earner / single parent",
        familyBonus: "Family Bonus Plus",
        taxableBenefit: "Non-cash benefit (Sachbezug) per month",
        companyCar: "Company car benefit per month",
        allowance: "Tax allowance per month",
